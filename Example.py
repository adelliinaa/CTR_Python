...
# Joint variables
q = np.array([0.05, 0.015, 0.018, np.pi / 2, 5 * np.pi / 2, 3 * np.pi / 2])
...
# Save CTR shapes into csv file
df = pd.DataFrame(CTR)
df.to_csv(r'/Users/adelina/Desktop/CTR_Python/CTR_shapes.csv', index=False)
#np.savetxt('/Users/adelina/Desktop/CTR_Python/FileName.csv', CTR,  delimiter=',')
...
plt.legend()
#plt.show()
fig.savefig('/Users/adelina/Desktop/CTR_Python/fig.pdf')
